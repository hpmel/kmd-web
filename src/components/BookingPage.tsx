...
const copy = {
  fr: {
    ...
    bonusNote: 'Séance distincte de 30 minutes · Places limitées · Valeur de 95 $ offerte',
  ...
  en: {
    ...
    bonusNote: 'Separate 30-minute session · Limited availability · $95 value included',
    panelLabel: 'Book now',
